...
export default function Footer() {
    return (
        <footer id="contact" className="bg-foreground text-background py-24 px-6 md:px-12 rounded-t-[3rem] relative z-10 mt-12">
            <div className="max-w-7xl mx-auto flex flex-col justify-between min-h-[60vh]">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 mt-12">
                        <a href="mailto:juniortagne2001@gmail.com" className="px-8 py-4 border border-white/20 rounded-full hover:bg-white hover:text-black transition-all text-xl">
                            juniortagne2001@gmail.com
                        </a>
                        <a href="tel:+237694656790" className="px-8 py-4 border border-white/20 rounded-full hover:bg-white hover:text-black transition-all text-xl">
                            +237 694 656 790
                        </a>
                    </div>
